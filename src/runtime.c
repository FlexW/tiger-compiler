/**
 * @file runtime.c
 * Functions for the runtime of the tiger language.
 */
...
int
size (struct string *s)
{
  return s->length;
}

struct string *
substring (struct string *s,
           int            first,
           int            n)
{
